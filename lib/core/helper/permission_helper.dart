...
class PermissionHelper {
  ...
  static Future<bool> isCameraGranted({
    ...
    _handleDialog(
      ...
      permanentlyDeniedMsg: permanentlyDeniedMsg ?? deniedMsg,
      deniedMsg: (showDeniedMessage) ? deniedMsg : null,
    );
  ...
  static Future<bool> isStorageGranted({
    bool showDeniedMessage = true,
    String? permanentlyDeniedMsg,
    String deniedMsg = 'need permission storage',
  }) async {
  ...
  static Future<bool> isPhotoGranted({
    ...
    if (Platform.isIOS) {
      if (permission.isPermanentlyDenied) {
        openSettings(permanentlyDeniedMsg ?? deniedMsg);
        return false;
      }
      return true;
    } else {
  ...
  static Future<bool> manageExternalStorage({
    ...
    if (Platform.isAndroid) {
      ...
      if (permission.isPermanentlyDenied) {
        PermissionHelper.openSettings(deniedMsg);
      } else {
        // SnackBarHelper.warning(message: deniedMsg);
      }
      return permission.isGranted;
    } else {
      return true;
